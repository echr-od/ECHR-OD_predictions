...
def run(console, build, force):
    ...
    for i, flavor in enumerate(FLAVORS.keys()):
            for k, method in enumerate(classifiers.keys()):
                ...
                status = status_check('multilabel', exp_results, dataset_name, method)
        ...
        'multilabel': 
            ...
            "seed": 123456,
                "train": {
                    ...
                    "train_f1_weighted_std": 0.0,
                    "train_recall": 1.0,
                    "train_recall_std": 0.0,
                    "train_zero_one_loss": 0.0,
                    "train_zero_one_loss_std": 0.0,
                    "train_coverage_error": 1.4389277673332797,
                    "train_coverage_error_std": 0.005164102941083277,
                    "train_label_ranking_loss": 0.0,
                    "train_label_ranking_loss_std": 0.0,
                    "train_hamming_loss": 0.0,
                    "train_hamming_loss_std": 0.0,
                    "train_jaccard_similarity_score": 1.0,
                    "train_jaccard_similarity_score_std": 0.0,
                    "train_average_precision": 1.0,
                    "train_average_precision_std": 0.0,
                    "train_precision": 1.0,
                    "train_precision_std": 0.0
                },
                "test": {
                    "test_acc": 0.811605291192976,
                    "test_acc_std": 0.036887678432664106,
                    "test_f1_weighted": 0.8678088770413476,
                    "test_f1_weighted_std": 0.02594169663389747,
                    "test_recall": 0.8632242851364111,
                    "test_recall_std": 0.028565463897656372,
                    "test_zero_one_loss": 0.188394708807024,
                    "test_zero_one_loss_std": 0.036887678432664106,
                    "test_coverage_error": 9.936317772978564,
                    "test_coverage_error_std": 1.732407113223856,
                    "test_label_ranking_loss": 0.11885674886757794,
                    "test_label_ranking_loss_std": 0.025086292963710056,
                    "test_hamming_loss": 0.006759626832019344,
                    "test_hamming_loss_std": 0.0013432106337121885,
                    "test_jaccard_similarity_score": 0.767413821265424,
                    "test_jaccard_similarity_score_std": 0.04049376070102418,
                    "test_average_precision": 0.7573645926696739,
                    "test_average_precision_std": 0.04423605797341378,
                    "test_precision": 0.872575556605842,
                    "test_precision_std": 0.025199304939632558
                },
                "time": {
                    "fit_time": 145.19585342407225,
                    "score_time": 17.587941384315492
                }
        }
    }
